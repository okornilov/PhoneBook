 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://personws.services.company.ru/")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL(ConfigUtils.getHostUrl() + "/personws/personws?wsdl");
