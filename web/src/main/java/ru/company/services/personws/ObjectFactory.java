...
public class ObjectFactory {
    ...
    private final static QName _TCheckSessionRequest_QNAME = new QName("http://personws.services.company.ru/", "tCheckSessionRequest");
    ...
    private final static QName _CheckSessionResponse_QNAME = new QName("http://personws.services.company.ru/", "checkSessionResponse");
    private final static QName _CheckSession_QNAME = new QName("http://personws.services.company.ru/", "checkSession");
    ...
    /**
     * Create an instance of {@link TCheckSessionRequest }
     * 
     */
    public TCheckSessionRequest createTCheckSessionRequest() {
        return new TCheckSessionRequest();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TCheckSessionRequest }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://personws.services.company.ru/", name = "tCheckSessionRequest")
    public JAXBElement<TCheckSessionRequest> createTCheckSessionRequest(TCheckSessionRequest value) {
        return new JAXBElement<TCheckSessionRequest>(_TCheckSessionRequest_QNAME, TCheckSessionRequest.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://personws.services.company.ru/", name = "checkSessionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://personws.services.company.ru/", name = "checkSession")
