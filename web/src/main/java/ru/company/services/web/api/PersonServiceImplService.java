 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://personws.services.company.ru/", wsdlLocation = "http://localhost:8080/personws/personws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("http://personws.services.company.ru/", "PersonServiceImplService");
    ...
    public PersonService getPersonServiceImplPort() {
        return super.getPort(new QName("http://personws.services.company.ru/", "PersonServiceImplPort"), PersonService.class);
    }
    ...
    public PersonService getPersonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://personws.services.company.ru/", "PersonServiceImplPort"), PersonService.class, features);
    }
